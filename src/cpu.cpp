...
#define STR(var) #var
CPU::CPU() {
    CPUregisters = {0x00, 0x00, 0x00, 0x01FD, {false, false, false, false, false, true, false, false}, 0xC000};
    for (int i = 0; i < 4; i++) {
        for (int j = 0; j < 4; j++) {
            bg_palette[i][j] = 0xffffff;
        }
    }
}
